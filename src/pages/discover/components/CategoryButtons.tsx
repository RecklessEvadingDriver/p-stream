        ...
        <div className="flex space-x-2 py-1">
          {categories.map((category) => (
            <button
              ...
              type="button"
              className="whitespace-nowrap flex items-center space-x-2 rounded-full px-4 text-white py-2 bg-pill-background bg-opacity-50 hover:bg-pill-backgroundHover transition-all duration-200 hover:scale-105 shadow-sm hover:shadow-md"
